...
export default function PrivacyPage() {
  return (
    <LegalPage title="Privacy Notice" intro="This notice explains how EverAft uses personal information when you browse the site, create an account, send an enquiry, apply to list a business, receive a business-listing invitation or subscribe to updates." updated="11 July 2026">
