  ...
  return (
    <aside aria-label={`${category.label} filters`} className="self-start rounded-3xl border border-[#cfc3b3] bg-white p-5 lg:sticky lg:top-24 lg:max-h-[calc(100vh-7rem)] lg:overflow-y-auto">
      <div className="flex items-center justify-between gap-3">
        <div>
          <p className="text-xs font-semibold uppercase tracking-[0.15em] text-[#9c542d]">{category.label} match</p>
      ...
      <p className="mt-4 text-xs leading-5 text-[#625f57]">Quote-only suppliers remain visible so you can request pricing and enter your own working estimate.</p>
    </aside>
  );
}
