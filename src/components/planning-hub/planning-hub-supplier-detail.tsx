      ...
      {loading ? (
        ...
        <>
          <div className="relative">
            ...
            <button aria-label={`Close ${category.label.toLowerCase()} details`} className="focus-ring absolute right-3 top-3 z-10 inline-grid min-h-11 min-w-11 place-items-center rounded-full bg-white text-[#173526] shadow" onClick={onClose} type="button">
              <X size={19} />
            </button>
          </div>
