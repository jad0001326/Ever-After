    ...
    return (
      <section className="rounded-3xl border border-[#d9d0c3] bg-white p-8 text-center sm:p-12">
        ...
        <div className="mt-6 flex flex-wrap justify-center gap-3">
          <Link className="focus-ring inline-flex min-h-11 items-center rounded-full border border-[#173526] px-5 text-sm font-semibold text-[#173526]" href="/planning-hub/photography" prefetch={false}>Clear filters</Link>
