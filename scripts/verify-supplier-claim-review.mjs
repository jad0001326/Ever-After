...
try {
  ...
  // Apply the already-deployed profile hotfix before the new claim migration,
  // matching production and fresh-stack timestamp order. The claim migration
  // deliberately repeats that boundary idempotently before exposing its RPC.
